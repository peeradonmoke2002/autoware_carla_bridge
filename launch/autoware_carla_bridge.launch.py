...
def generate_launch_description():
    ...
    autoware_carlar_bridge = Node(
        ...
        remappings=[
                ...
                ('~/input/imu', '/carla/ego_vehicle/imu'),
                ...
                ('~/output/image', '/sensing/camera/CAM_FRONT/image_raw'),
                ('~/output/camera_info', '/sensing/camera/CAM_FRONT/camera_info'),
                ('~/output/image_view', '/sensing/camera/CAM_VIEW/image_raw'),
